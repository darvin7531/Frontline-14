...
frontline-territory-one-name = Старый Перевал
frontline-territory-one-description = Узкий проход через западные холмы.
frontline-territory-two-name = Железная Долина
frontline-territory-two-description = Промышленная долина между фронтами.
frontline-territory-three-name = Перекрёсток
frontline-territory-three-description = Здесь сходятся дороги центрального фронта.
frontline-territory-four-name = Восточные Рубежи
frontline-territory-four-description = Восточный подступ к линии фронта.
frontline-territory-five-name = Южный Хребет
frontline-territory-five-description = Удобная для обороны возвышенность на юге.
...
frontline-victory-status = Для победы нужно {$required} очков
...
frontline-refinery-recipe-steel = Производство основных материалов
frontline-refinery-recipe-technology-alloy = Синтез технологического сплава
frontline-refinery-recipe-unknown = Неизвестный рецепт
...
ent-FrontlineFactory = фронтовая фабрика
    .desc = Производит физические фронтовые припасы из очищенных ресурсов.
ent-FrontlineSupplyCrate = ящик фронтового снабжения
    .desc = Общедоступный ящик для физической перевозки фронтовых припасов.
ent-FrontlineWeaponPistolMk58 = фронтовой Mk 58
    .desc = Обычный Mk 58, выпускаемый для фронта без магазина.
frontline-factory-title = Фронтовая фабрика
frontline-factory-input-heading = Приёмная камера
frontline-factory-input-empty = Пусто. Используйте подходящую стопку ресурсов на фабрике, чтобы загрузить её.
frontline-factory-stack-line = {$name}: {$amount}
frontline-factory-stack-amount = {$amount} {$name}
frontline-factory-eject-all = Выгрузить всё сырьё
frontline-factory-recipes-heading = Рецепты
frontline-factory-recipe-line = {$recipe}: {$input} → {$amount} {$output} ({$seconds} с)
frontline-factory-produce = Произвести: {$recipe}
frontline-factory-queue-heading = Очередь
frontline-factory-queue-empty = Очередь пуста.
frontline-factory-status-processing = производится
frontline-factory-status-waiting = ожидает
frontline-factory-recipe-mk58 = Пистолет Mk 58
frontline-factory-recipe-magazine-pistol = Пистолетный магазин
frontline-factory-recipe-brutepack = Набор пластырей
frontline-factory-recipe-supply-crate = Ящик фронтового снабжения
frontline-factory-recipe-unknown = Неизвестный рецепт
frontline-factory-item-unknown = Неизвестный предмет
frontline-factory-job-line = #{$position} {$recipe}: {$status}, осталось {$seconds} с
frontline-factory-invalid-input = Фабрика не принимает этот предмет.
frontline-factory-insufficient-input = В приёмной камере недостаточно материала для этого рецепта.
